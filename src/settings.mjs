...
export const defaultRules = Object.freeze([
  { id: 'investigate-before-claim', enabled: true, title: '先查证据', description: '判断用户请求是否需要先检查证据。', phase: 'before', input: 'latest-user-message', customInput: '',
  ...
  { id: 'evidence-after-answer', enabled: true, title: '工具失败提醒', description: '工具返回失败时提醒核对证据。', phase: 'after', input: 'tool-results', customInput: '',
