...
export function validateRules(rules) {
  ...
  return rules.map(rule => {
    ...
    return { id: rule.id, enabled: rule.enabled, phase: rule.phase, input, customInput, questionSource, questionScript, question, options: validOptions, threshold: rule.threshold };
  });
}
